...
inline void ReadMLP::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -0.935846180290245;
   fWeightMatrix0to1[1][0] = 1.54645722492679;
   fWeightMatrix0to1[2][0] = 1.10494740873014;
   fWeightMatrix0to1[3][0] = 5.45332869774383;
   fWeightMatrix0to1[4][0] = -1.17147688381686;
   fWeightMatrix0to1[5][0] = -2.09137245122556;
   fWeightMatrix0to1[6][0] = -0.38786218008984;
   fWeightMatrix0to1[7][0] = 2.23188020414521;
   fWeightMatrix0to1[8][0] = 1.88607233306972;
   fWeightMatrix0to1[9][0] = -0.663541920089882;
   fWeightMatrix0to1[10][0] = -4.99245548966475;
   fWeightMatrix0to1[0][1] = -0.0950853310929569;
   fWeightMatrix0to1[1][1] = -4.95379031825703;
   fWeightMatrix0to1[2][1] = 0.358379532024329;
   fWeightMatrix0to1[3][1] = 2.94549826588624;
   fWeightMatrix0to1[4][1] = 1.27195396241753;
   fWeightMatrix0to1[5][1] = -1.03781988038402;
   fWeightMatrix0to1[6][1] = 5.15605713677704;
   fWeightMatrix0to1[7][1] = 0.159625404329337;
   fWeightMatrix0to1[8][1] = 5.60465766987275;
   fWeightMatrix0to1[9][1] = -1.19186669706748;
   fWeightMatrix0to1[10][1] = 1.52862065850208;
   fWeightMatrix0to1[0][2] = 2.76260197188696;
   fWeightMatrix0to1[1][2] = -0.406819368778374;
   fWeightMatrix0to1[2][2] = -0.00363651069391288;
   fWeightMatrix0to1[3][2] = 0.514777217548629;
   fWeightMatrix0to1[4][2] = 2.11047136436115;
   fWeightMatrix0to1[5][2] = -1.80777337595212;
   fWeightMatrix0to1[6][2] = -0.574671065390536;
   fWeightMatrix0to1[7][2] = 0.644386681273359;
   fWeightMatrix0to1[8][2] = 0.812672928745965;
   fWeightMatrix0to1[9][2] = 2.92034546510724;
   fWeightMatrix0to1[10][2] = -1.02499278962719;
   fWeightMatrix0to1[0][3] = 0.120621562914195;
   fWeightMatrix0to1[1][3] = 0.408545835360882;
   fWeightMatrix0to1[2][3] = 0.267943584646478;
   fWeightMatrix0to1[3][3] = -4.82034187055667;
   fWeightMatrix0to1[4][3] = 2.26328150371572;
   fWeightMatrix0to1[5][3] = -1.81624186991519;
   fWeightMatrix0to1[6][3] = -1.58836429064985;
   fWeightMatrix0to1[7][3] = 1.46709179193425;
   fWeightMatrix0to1[8][3] = 0.219568120182275;
   fWeightMatrix0to1[9][3] = 0.896581217516185;
   fWeightMatrix0to1[10][3] = 1.00266274172221;
   fWeightMatrix0to1[0][4] = -1.98559833791314;
   fWeightMatrix0to1[1][4] = -3.99039782973215;
   fWeightMatrix0to1[2][4] = 2.04101667430293;
   fWeightMatrix0to1[3][4] = -0.298042633958894;
   fWeightMatrix0to1[4][4] = 1.07236170453562;
   fWeightMatrix0to1[5][4] = 0.999526750491525;
   fWeightMatrix0to1[6][4] = 0.528020712220765;
   fWeightMatrix0to1[7][4] = 1.23088448159172;
   fWeightMatrix0to1[8][4] = -2.90400219391478;
   fWeightMatrix0to1[9][4] = 1.759836424564;
   fWeightMatrix0to1[10][4] = -0.264998472576665;
   fWeightMatrix0to1[0][5] = -0.832614821890537;
   fWeightMatrix0to1[1][5] = -0.619750927434686;
   fWeightMatrix0to1[2][5] = -1.48423229391326;
   fWeightMatrix0to1[3][5] = 1.71120523853384;
   fWeightMatrix0to1[4][5] = 1.31747529683797;
   fWeightMatrix0to1[5][5] = -2.17101182587446;
   fWeightMatrix0to1[6][5] = 0.061407238700851;
   fWeightMatrix0to1[7][5] = 0.117833154948418;
   fWeightMatrix0to1[8][5] = -0.158592620968044;
   fWeightMatrix0to1[9][5] = 2.70289455451347;
   fWeightMatrix0to1[10][5] = -0.789302835993409;
   fWeightMatrix0to1[0][6] = 1.57852590601636;
   fWeightMatrix0to1[1][6] = 1.19161517540897;
   fWeightMatrix0to1[2][6] = -1.99818096855337;
   fWeightMatrix0to1[3][6] = -0.0964815896075799;
   fWeightMatrix0to1[4][6] = -0.396165850232813;
   fWeightMatrix0to1[5][6] = -0.587999960347904;
   fWeightMatrix0to1[6][6] = 0.117077290090201;
   fWeightMatrix0to1[7][6] = 0.870181031768326;
   fWeightMatrix0to1[8][6] = 0.92448182850174;
   fWeightMatrix0to1[9][6] = -1.43024155719169;
   fWeightMatrix0to1[10][6] = 0.204534998016778;
   fWeightMatrix0to1[0][7] = -0.643107773231323;
   fWeightMatrix0to1[1][7] = -0.00766079397048075;
   fWeightMatrix0to1[2][7] = -0.552217827669282;
   fWeightMatrix0to1[3][7] = -0.35736449822928;
   fWeightMatrix0to1[4][7] = 0.339320940751451;
   fWeightMatrix0to1[5][7] = 0.912499729713936;
   fWeightMatrix0to1[6][7] = -0.257848197691527;
   fWeightMatrix0to1[7][7] = -0.776835007820595;
   fWeightMatrix0to1[8][7] = -0.0359290398632499;
   fWeightMatrix0to1[9][7] = -0.024007732315231;
   fWeightMatrix0to1[10][7] = 0.185428383605967;
   fWeightMatrix0to1[0][8] = -1.53465674253631;
   fWeightMatrix0to1[1][8] = 0.539574832314776;
   fWeightMatrix0to1[2][8] = -0.517795804466446;
   fWeightMatrix0to1[3][8] = -2.02181249540128;
   fWeightMatrix0to1[4][8] = 1.92670683926214;
   fWeightMatrix0to1[5][8] = -1.92933121426596;
   fWeightMatrix0to1[6][8] = 0.149187581803807;
   fWeightMatrix0to1[7][8] = 1.57752125006737;
   fWeightMatrix0to1[8][8] = -0.839713831703151;
   fWeightMatrix0to1[9][8] = -1.73832330497462;
   fWeightMatrix0to1[10][8] = -1.24125140083807;
   fWeightMatrix0to1[0][9] = -0.240201238961244;
   fWeightMatrix0to1[1][9] = -0.453014536679407;
   fWeightMatrix0to1[2][9] = -1.37605376010638;
   fWeightMatrix0to1[3][9] = 0.236342943535766;
   fWeightMatrix0to1[4][9] = 0.852343187320306;
   fWeightMatrix0to1[5][9] = -0.222556872049316;
   fWeightMatrix0to1[6][9] = 0.548212305327747;
   fWeightMatrix0to1[7][9] = -0.950809537533878;
   fWeightMatrix0to1[8][9] = 0.440733446095065;
   fWeightMatrix0to1[9][9] = 0.758299987537175;
   fWeightMatrix0to1[10][9] = -0.261072162893365;
   fWeightMatrix0to1[0][10] = -1.98016976074383;
   fWeightMatrix0to1[1][10] = 1.52510646291646;
   fWeightMatrix0to1[2][10] = -1.10466847029775;
   fWeightMatrix0to1[3][10] = -0.100057119082985;
   fWeightMatrix0to1[4][10] = -0.645581206659313;
   fWeightMatrix0to1[5][10] = 0.828028202036605;
   fWeightMatrix0to1[6][10] = -1.62554570655763;
   fWeightMatrix0to1[7][10] = -0.599601834034926;
   fWeightMatrix0to1[8][10] = -2.13833465079704;
   fWeightMatrix0to1[9][10] = -2.4169484073693;
   fWeightMatrix0to1[10][10] = -0.909311796390628;
   fWeightMatrix0to1[0][11] = 0.445418590079557;
   fWeightMatrix0to1[1][11] = -0.653346765746024;
   fWeightMatrix0to1[2][11] = 1.76798655061853;
   fWeightMatrix0to1[3][11] = 0.615114459857438;
   fWeightMatrix0to1[4][11] = -0.933930668747153;
   fWeightMatrix0to1[5][11] = 0.945214000123943;
   fWeightMatrix0to1[6][11] = 1.76926027933372;
   fWeightMatrix0to1[7][11] = -2.4777447696248;
   fWeightMatrix0to1[8][11] = 3.19631937174329;
   fWeightMatrix0to1[9][11] = -1.2772151218589;
   fWeightMatrix0to1[10][11] = -7.23273384570174;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = 3.9271669890164;
   fWeightMatrix1to2[0][1] = -3.75219906320401;
   fWeightMatrix1to2[0][2] = 3.00827877713498;
   fWeightMatrix1to2[0][3] = 1.80978418122509;
   fWeightMatrix1to2[0][4] = -0.247823893930926;
   fWeightMatrix1to2[0][5] = -0.455915799883435;
   fWeightMatrix1to2[0][6] = -5.40618099229992;
   fWeightMatrix1to2[0][7] = 0.895165297798292;
   fWeightMatrix1to2[0][8] = 3.44199210458409;
   fWeightMatrix1to2[0][9] = -3.06377451998743;
   fWeightMatrix1to2[0][10] = -5.41666760259361;
   fWeightMatrix1to2[0][11] = -0.200480096778948;
}
